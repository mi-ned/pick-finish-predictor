...
double get historyCardHandlePillWidth => mode == DisplayMode.iPadLandscape ? 30.0 : 0.0;

double get historyCardHandlePillHeight => mode == DisplayMode.iPadLandscape ? 5.0 : 0.0;

double get historyCardHandlePillBorderRadius => mode == DisplayMode.iPadLandscape ? 25.0 : 0.0;

double get historyCardHandlePillSpacing => mode == DisplayMode.iPadLandscape ? 8.0 : 0.0;
