...
import 'package:pick_finish_predictor_ui/widgets/interactive_drag_handle.dart';
import 'package:pick_finish_predictor_ui/widgets/search_bar_highlighted_text.dart';

class HelpContentView extends StatefulWidget {
  final AppStrings strings;
  final AppStyle style;
  final VoidCallback onClose;
  final bool showDragHandle;

  const HelpContentView({
    super.key,
  ...
  @override
  State<HelpContentView> createState() => _HelpContentViewState();
}

class _HelpContentViewState extends State<HelpContentView> {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.symmetric(
          vertical: widget.style.helpContentSheetSearchBarVerticalContentPadding,
        ),
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                left: widget.style.helpContentSheetAccordianBodyHorizontalMargin,
                right: widget.style.helpContentSheetAccordianBodyHorizontalMargin,
                bottom: widget.style.helpContentSheetAccordianBodyVerticalMargin,
              ),
              child: Align(
