  ...
  Widget _buildLeftSideIconButtons(AppStyle style) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          HeaderBranding(modeName: appStrings.modeStatic, //to be updated
              strings: appStrings,
              style: style,
              ),
        ],
  ...
  Widget _buildRightSideIconButtons(AppStyle style) {
    return Padding(
      ...
      child: Row(
          children: [
            //const Spacer(),
            Expanded(child: Align(alignment: Alignment.centerLeft,child: HelpIconButton(tooltip: appStrings.tooltipHelp, onPressed: onHelp),),),
            //const Spacer(),
            HistoryIconButton(
